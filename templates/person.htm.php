...
<form name="fperson" action="<?= getValue('phpmodule') ?>" method="post">
    ...
    <div class="form-group row">
        <label for="tel_gesch" class="col-sm-2 col-form-label">Telefon Gesch�ft</label>
        <div class="col-sm-10">
    ...
    <div class="form-group row">
        <div class="col-auto">
            ...
            <input class="btn btn-outline-secondary" type="submit" name="loeschen" value="l�schen" <?= getAdditionalAttributes('loeschen') ?>>
        </div>
